        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, 1, "Lauro", "Oliveira","15"),
                    new Professor(2, 2, "Roberto", "Soares","15"),
                    new Professor(3, 3, "Ronaldo", "Marconi","15"),
                    new Professor(4, 4, "Rodrigo", "Carvalho","15"),
                    new Professor(5, 5, "Alexandre", "Montanha","15"),
                });
